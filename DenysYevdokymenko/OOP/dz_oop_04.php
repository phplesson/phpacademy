...
require_once 'dz_oop_03.php';

class NewHuman extends Human
{
    protected $labelTimeCreate;

    public function __construct($name,$age)
    {
        parent::__construct($name,$age);
        $this->labelTimeCreate = date("d-m-Y H:i:s");
    }
...
$kolya = new NewHuman("Коля",28);
$dima = new NewHuman("Дима", 29);
$sveta = new NewHuman("Света", 30);


echo $kolya,$dima,$sveta;
