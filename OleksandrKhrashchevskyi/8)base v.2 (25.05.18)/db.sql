...
-- Dumping data for table pansionat.compositions: ~0 rows (approximately)
...
-- Dumping data for table pansionat.dishes: ~33 rows (approximately)
DELETE FROM `dishes`;
...
-- Dumping data for table pansionat.dishTypes: ~5 rows (approximately)
...
-- Dumping data for table pansionat.menus: ~21 rows (approximately)
DELETE FROM `menus`;
...
-- Dumping data for table pansionat.products: ~17 rows (approximately)
...
-- Dumping data for table pansionat.recipes: ~33 rows (approximately)
DELETE FROM `recipes`;
...
-- Dumping data for table pansionat.storage: ~17 rows (approximately)
DELETE FROM `storage`;
...
-- Dumping data for table pansionat.suppliers: ~8 rows (approximately)
...
-- Dumping data for table pansionat.supplys: ~37 rows (approximately)
DELETE FROM `supplys`;
