...
-- Dumping data for table pansionat.compositions: ~147 rows (approximately)
...
-- Dumping structure for table pansionat.dishes
...
-- Dumping data for table pansionat.dishes: ~32 rows (approximately)
DELETE FROM `dishes`;
...
-- Dumping structure for table pansionat.dishTypes
...
-- Dumping data for table pansionat.dishTypes: ~4 rows (approximately)
...
-- Dumping structure for table pansionat.meals
...
-- Dumping data for table pansionat.meals: ~3 rows (approximately)
DELETE FROM `meals`;
...
-- Dumping structure for table pansionat.menus
...
-- Dumping data for table pansionat.menus: ~20 rows (approximately)
DELETE FROM `menus`;
...
-- Dumping structure for table pansionat.products
...
-- Dumping data for table pansionat.products: ~16 rows (approximately)
...
-- Dumping structure for table pansionat.recipes
...
-- Dumping data for table pansionat.recipes: ~32 rows (approximately)
DELETE FROM `recipes`;
...
-- Dumping structure for table pansionat.storage
...
-- Dumping data for table pansionat.storage: ~16 rows (approximately)
DELETE FROM `storage`;
...
-- Dumping structure for table pansionat.suppliers
...
-- Dumping data for table pansionat.suppliers: ~7 rows (approximately)
...
-- Dumping structure for table pansionat.supplys
...
-- Dumping data for table pansionat.supplys: ~36 rows (approximately)
DELETE FROM `supplys`;
