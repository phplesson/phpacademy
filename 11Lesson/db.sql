...
-- Дамп данных таблицы pansionat.compositions: ~147 rows (приблизительно)
...
-- Дамп данных таблицы pansionat.dishes: ~32 rows (приблизительно)
DELETE FROM `dishes`;
...
-- Дамп данных таблицы pansionat.dishtypes: ~4 rows (приблизительно)
...
-- Дамп данных таблицы pansionat.menus: ~20 rows (приблизительно)
DELETE FROM `menus`;
...
-- Дамп данных таблицы pansionat.products: ~16 rows (приблизительно)
...
-- Дамп данных таблицы pansionat.recipes: ~32 rows (приблизительно)
DELETE FROM `recipes`;
...
-- Дамп данных таблицы pansionat.storage: ~0 rows (приблизительно)
DELETE FROM `storage`;
...
-- Дамп данных таблицы pansionat.suppliers: ~0 rows (приблизительно)
...
-- Дамп данных таблицы pansionat.supplys: ~0 rows (приблизительно)
DELETE FROM `supplys`;
